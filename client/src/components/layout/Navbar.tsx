...
const navigationItems: Array<{ href?: string; label: string; to?: string }> = [
      ...
      <Container width="wide">
        <nav aria-label="Primary navigation" className="app-navbar__inner">
          <Link
            ...
            to="/"
          >
            <span aria-hidden="true" className="app-navbar__mark">
              <i />
              <i />
              <i />
            </span>
          ...
          >
            ...
            >
              <div className="app-navbar__drawer-header">
                <span className="app-navbar__brand">TransitOps</span>
                <Button
              ...
              <div className="app-navbar__drawer-links">
                {navigationItems.map((item) =>
                  item.to ? (
                    <Link
                      aria-current={
              ...
              <div className="app-navbar__drawer-actions">
                ...
                <Button onClick={closeDrawer}>Start Free Trial</Button>
              </div>
            </motion.div>
          </motion.div>
        ) : null}
